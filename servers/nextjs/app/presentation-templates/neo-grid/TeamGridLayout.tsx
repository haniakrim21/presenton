            ...
            >
                ...
                <div className="flex flex-col h-full px-12 py-10">
                    ...
                    <div className="mb-5 flex-shrink-0">
                        ...
                        {subtitle && (
                            <p
                                className="text-[13px] leading-relaxed max-w-[600px] mt-3"
                    ...
                    {/* 3-col grid with full borders between cells — table-like, no rounded corners */}
                    <div
                        className="flex-1 grid grid-cols-3 min-h-0 overflow-hidden"
                    ...
                    >
                        {members?.map((member, index) => {
                            ...
                            return (
                                <div
                                    key={index}
                                    className="flex flex-col items-center text-center overflow-hidden px-4 py-4"
                                    style={{
                                        backgroundColor: 'var(--card-color, #F3F4F6)',
                                        borderRight: !isLastInRow ? '1px solid var(--stroke, #E5E7EB)' : 'none',
                                        borderBottom: !isLastRow ? '1px solid var(--stroke, #E5E7EB)' : 'none',
                                    }}
                                >
                                    {/* Avatar in square frame — rounded-none */}
                                    <div
                                        className="flex-shrink-0 mb-3 overflow-hidden"
                                        style={{
                                            width: '56px',
                                            height: '56px',
                                            borderRadius: 0,
