            ...
            >
                ...
                <div className="flex flex-col h-full px-14 pt-10 pb-8">
                    ...
                    <div className="mb-5 flex-shrink-0">
                        ...
                        {description && (
                            <p
                                className="text-[15px] font-medium leading-relaxed max-w-[520px]"
                    ...
                    {/* Table */}
                    <div className="flex-1 flex flex-col min-h-0 overflow-hidden rounded-xl" style={{ border: '2px solid var(--stroke, #E5E7EB)' }}>
                        {/* Header row — TALL (py-5) with 18px bold text */}
                        <div
                            className="flex flex-shrink-0"
                            style={{ borderBottom: '3px solid var(--stroke, #E5E7EB)' }}
                        >
                            ...
                            <div
                                ...
                                style={{
                                    width: '28%',
                                    minWidth: '160px',
                                    borderRight: '2px solid var(--stroke, #E5E7EB)',
                                    backgroundColor: 'var(--card-color, #F3F4F6)',
                                }}
                            >
                                <span
                                    className="font-bold uppercase tracking-widest"
                                    style={{ fontSize: '13px', color: 'var(--background-text, #101828)', opacity: 0.45, fontFamily: 'var(--heading-font-family, Inter)', letterSpacing: '0.1em' }}
                                >
                                    Feature
                                </span>
                            </div>
                            ...
                            {columns?.map((col, colIndex) => (
                                <div
                                    ...
                                    style={{
                                        ...
                                        borderRight: colIndex < (columns?.length ?? 0) - 1 ? '2px solid var(--stroke, #E5E7EB)' : 'none',
                                    }}
                                >
                                    <span
                                    ...
                                    {col.highlighted && (
                                        <span
                                            className="ml-2 font-bold uppercase tracking-widest px-2 py-[3px] rounded-full"
                                            style={{ fontSize: '10px', backgroundColor: 'rgba(255,255,255,0.25)', color: '#ffffff', fontFamily: 'var(--body-font-family, Inter)' }}
                                        >
                                            Best
                                        </span>
                                    )}
                                    ...
                                    >
                                        ...
                                        {columns?.map((col, colIndex) => (
                                            <div
                                                ...
                                                style={{
                                                    borderLeft: col.highlighted ? '4px solid var(--primary-color, #6366F1)' : 'none',
