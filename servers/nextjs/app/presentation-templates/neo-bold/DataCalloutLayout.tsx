        ...
        <>
            ...
            >
                ...
                <div className="flex flex-col h-full px-14 pt-10 pb-8">
                    ...
                    {/* Center stat area — with circular glow behind the stat */}
                    <div className="flex-1 flex flex-col items-center justify-center text-center min-h-0 relative">
                        {/* Subtle circular glow behind stat */}
                        {statValue && (
                            <div
                        ...
                        {/* Giant stat value — 120px extrabold */}
                        {statValue && (
                            <span
                        ...
                        {/* Stat label — 26px font-bold */}
                        {statLabel && (
                            <p
                                className="font-bold mt-3 mb-4 relative z-10"
                                style={{
                                    fontSize: '26px',
                        ...
                        {description && (
                            <p
                                className="text-[15px] leading-relaxed max-w-[540px] relative z-10"
                    ...
                    {highlights && highlights.length > 0 && (
                        <div
                            className="flex-shrink-0 flex items-start justify-center gap-8 pt-4 border-t-[4px]"
                            style={{ borderColor: 'var(--primary-color, #6366F1)', borderTopWidth: '4px', borderTopStyle: 'solid', borderTopColor: 'var(--primary-color, #6366F1)', opacity: 1 }}
                        >
                            {highlights.map((highlight, index) => (
                                <div key={index} className="flex items-start gap-2 max-w-[200px]">
                                    <span
                                        className="flex-shrink-0 rounded-full mt-[5px]"
                                        style={{ width: '8px', height: '8px', backgroundColor: 'var(--primary-color, #6366F1)' }}
                                    />
                                    <span
