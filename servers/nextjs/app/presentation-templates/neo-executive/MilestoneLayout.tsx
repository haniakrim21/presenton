            ...
            >
                ...
                <div className="flex flex-col h-full px-16 pt-14 pb-10">
                    ...
                    <div className="flex-1 relative flex items-center min-h-0">
                        {/* Vertical center line — thin hairline */}
                        <div
                            ...
                            {milestones?.map((milestone, index) => {
                                ...
                                return (
                                    <div key={index} className="relative flex items-center w-full">
                                            ...
                                            {isLeft ? (
                                                <div className="flex flex-col items-end max-w-[44%]">
                                                    ...
                                                    <span
                                                        ...
                                                        style={{ color: 'var(--primary-color, #6366F1)', letterSpacing: '0.1em', opacity: 0.7 }}
                                                    >
                                                        {milestone.date}
                                                    </span>
                                                    {/* Card — transparent, only bottom border */}
                                                    <div
                                                    ...
                                                    >
                                                        ...
                                                        {milestone.description && (
                                                            <p
                                                                className="text-[11px] font-normal leading-[1.7]"
                                                                style={{ color: 'var(--background-text, #101828)', opacity: 0.65, fontFamily: 'var(--body-font-family, Inter)' }}
                                                            >
                                                                {milestone.description}
                                                            </p>
                                        ...
                                        {/* Center dot — small 5px, filled or hollow */}
                                        <div className="relative z-10 flex-shrink-0 flex items-center justify-center w-4 h-4">
                                            {milestone.completed ? (
                                                <div
