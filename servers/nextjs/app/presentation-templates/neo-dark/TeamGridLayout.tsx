        ...
        <>
            ...
            >
                ...
                <div className="flex flex-col h-full px-14 pt-12 pb-10">
                    ...
                    {/* Team grid — all member cards inverted */}
                    <div className="flex-1 grid grid-cols-3 gap-4 min-h-0 overflow-hidden">
                        {members?.map((member, index) => (
                            <div
                                key={index}
                                className="rounded-lg px-5 py-4 flex flex-col items-center text-center overflow-hidden"
                                style={{
                                    backgroundColor: 'var(--primary-color, #6366F1)',
                                    boxShadow: '0 4px 20px rgba(0,0,0,0.25), inset 0 0 0 1px rgba(255,255,255,0.1)',
                                }}
                            >
                                {/* Avatar with inset glow ring */}
                                <div
                                    className="w-16 h-16 rounded-full overflow-hidden flex-shrink-0 mb-3"
                                    style={{
                                ...
                                {member.role && (
                                    <span
                                        ...
                                        style={{ color: 'var(--primary-text, #ffffff)', opacity: 0.7, letterSpacing: '0.07em', fontFamily: 'var(--body-font-family, Inter)' }}
                                    >
                                        {member.role}
                                    </span>
                                )}
                                ...
                                {/* Thin separator */}
                                <div
                                    className="w-10 mb-2 flex-shrink-0"
