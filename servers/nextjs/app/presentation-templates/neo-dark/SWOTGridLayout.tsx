        ...
        <>
            ...
            >
                ...
                <div className="flex flex-col h-full px-14 pt-12 pb-10">
                    ...
                    {/* 2x2 SWOT Grid — all quadrants inverted */}
                    <div className="flex-1 grid grid-cols-2 grid-rows-2 gap-3 min-h-0">
                        {quadrants?.map((quadrant, index) => (
                            <div
                                key={index}
                                className="rounded-lg px-5 py-4 flex flex-col overflow-hidden"
                                style={{
                            ...
                            >
                                {/* Quadrant label */}
                                <h3
                                    className="text-[14px] font-bold uppercase tracking-widest mb-3 flex-shrink-0"
                                    style={{ color: 'var(--primary-text, #ffffff)', fontFamily: 'var(--heading-font-family, Inter)', letterSpacing: '0.1em', opacity: 0.9 }}
                                >
                                    {quadrant.label}
                                </h3>
