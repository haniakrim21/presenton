                            ...
                            <div
                                ...
                                style={{
                                    ...
                                    boxShadow: tier.highlighted
                                        ? '0 0 20px var(--primary-color, #6366F1), inset 0 0 0 1px rgba(255,255,255,0.2)'
                                        : '0 4px 20px rgba(0,0,0,0.25), inset 0 0 0 1px rgba(255,255,255,0.1)',
                                    filter: tier.highlighted ? 'brightness(1.15)' : undefined,
                                }}
                            >
                                {/* Card body */}
                                <div className="flex flex-col flex-1 px-6 py-5">
                                    ...
                                    {tier.period && (
                                        <p
                                            ...
                                            style={{ color: 'var(--primary-text, #ffffff)', opacity: 0.6, fontFamily: 'var(--body-font-family, Inter)' }}
                                        >
                                            {tier.period}
                                        </p>
                                    )}
                                    ...
                                    <ul className="flex flex-col gap-[9px] flex-1">
                                        {tier.features?.map((feature, featureIndex) => (
                                            <li key={featureIndex} className="flex items-start gap-2">
                                                <span
                                                    className="flex-shrink-0 w-[15px] h-[15px] rounded-full flex items-center justify-center mt-[1px]"
