                ...
                <div className="flex flex-col h-full px-14 pt-12 pb-10">
                    ...
                    <div className="flex-1 flex flex-col justify-center min-h-0">
                        <div className="relative w-full" style={{ height: '320px' }}>
                            {/* Horizontal timeline line — gradient from primary to primary at 40% opacity, 4px rounded */}
                            <div
                                ...
                                style={{
                                    ...
                                    background: 'linear-gradient(90deg, var(--primary-color), var(--primary-color)66)',
                                }}
                            />
                            ...
                            {milestones?.map((milestone, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {isAbove && (
                                            <div
                                                className="mb-3 rounded-2xl overflow-hidden text-left"
                                                style={{
                                                    width: `${Math.max(140, Math.floor(820 / count) - 16)}px`,
                                                    boxShadow: '0 4px 16px rgba(0,0,0,0.08)',
                                                }}
                                            >
                                                {/* Two-tone card header */}
                                                <div
                                                ...
                                                >
                                                    ...
                                                    <span
                                                        ...
                                                        style={{ color: 'var(--primary-text, #FFFFFF)', letterSpacing: '0.07em' }}
                                                    >
                                                        {milestone.phase}
                                                    </span>
                                                </div>
