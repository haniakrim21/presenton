            ...
            >
                ...
                <div className="flex flex-col h-full px-16 pt-14 pb-10">
                    ...
                    <div className="flex-1 relative flex items-center min-h-0">
                        {/* Vertical center line — 4px rounded gradient bar */}
                        <div
                            className="absolute left-1/2 top-0 bottom-0 -translate-x-1/2 z-0 rounded-full"
                            style={{
                                width: '4px',
                                background: 'linear-gradient(180deg, var(--primary-color), var(--primary-color)66)',
                            }}
                        />
                                        ...
                                        <div className="flex-1 flex justify-end pr-6">
                                            {isLeft ? (
                                                <div className="flex flex-col items-end max-w-[44%]">
                                                    {/* Date as pill label */}
                                                    <span
                                                        className="inline-flex rounded-full px-3 py-0.5 text-[10px] font-bold uppercase tracking-widest mb-1"
                                                        style={{
