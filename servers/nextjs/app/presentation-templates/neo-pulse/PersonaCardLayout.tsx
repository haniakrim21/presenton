            ...
            >
                ...
                <div className="flex flex-col h-full px-14 pt-12 pb-10">
                    ...
                    <div className="flex-1 flex gap-8 min-h-0">
                        ...
                        <div className="flex flex-col items-center w-[280px] flex-shrink-0 justify-start pt-2">
                            {/* Circular image */}
                            <div
                                className="w-[120px] h-[120px] rounded-full overflow-hidden flex-shrink-0 mb-4 flex items-center justify-center"
                                style={{ backgroundColor: 'var(--card-color, #F3F4F6)', border: '3px solid var(--primary-color, #6366F1)' }}
                            >
                            ...
                            {persona?.bio && (
                                <p
                                    className="text-[12.5px] leading-[1.6] text-center"
                                    ...
                                    <ul className="flex flex-col gap-3">
                                        {goals.map((goal, index) => (
                                            <li key={index} className="flex items-start gap-3">
                                                {/* Checkmark icon */}
                                                <span className="flex-shrink-0 w-[18px] h-[18px] rounded-full flex items-center justify-center mt-[1px]"
                                                    style={{ backgroundColor: 'var(--primary-color, #6366F1)' }}
                                                >
