            ...
            >
                ...
                <div className="flex flex-col h-full px-16 pt-14 pb-12">
                    ...
                    <div className="mb-8">
                        {title && (
                            <h1
                                className="text-[38px] font-bold leading-tight mb-1"
                    ...
                    <div className="flex-1 flex items-center">
                        <div className="relative w-full flex items-center gap-0">
                            ...
                            <div
                                className="absolute left-0 right-0 h-[2px] top-1/2 -translate-y-1/2 z-0"
                            ...
                            {steps?.map((step, index) => (
                                <React.Fragment key={index}>
                                    {/* Step card */}
                                    <div
                                        className="relative z-10 flex flex-col flex-1 mx-2 rounded-md px-5 py-5 border-l-[3px]"
                                        style={{
                                    ...
                                    >
                                        ...
                                        <span
                                            ...
                                            style={{ color: 'var(--primary-color, #6366F1)', opacity: 0.9 }}
                                        >
                                            {step.number}
                                        </span>
                                        {step.title && (
