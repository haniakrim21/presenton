                ...
                <div className="flex flex-col h-full px-14 pt-12 pb-10">
                    ...
                    <div className="flex-1 grid grid-cols-3 gap-4 min-h-0 overflow-hidden">
                        {members?.map((member, index) => (
                            <div
                                key={index}
                                className="rounded-md px-5 py-4 flex flex-col items-center text-center overflow-hidden"
                                style={{
                                    backgroundColor: 'var(--card-color, #F3F4F6)',
                                    borderTop: '3px solid var(--primary-color, #6366F1)',
                                }}
                            >
                                {/* Avatar */}
                                <div
                                    className="w-16 h-16 rounded-full overflow-hidden flex-shrink-0 mb-3 ring-2"
                                    style={{ outline: '2px solid var(--primary-color, #6366F1)', outlineOffset: '2px' }}
                                >
                                    <img
                                ...
                                {member.role && (
                                    <span
                                        ...
                                        style={{ color: 'var(--primary-color, #6366F1)', letterSpacing: '0.07em' }}
                                    >
                                        {member.role}
                                    </span>
                                )}
