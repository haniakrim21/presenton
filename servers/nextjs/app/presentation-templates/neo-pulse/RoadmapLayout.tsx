                    ...
                    <div className="flex-1 flex flex-col justify-center min-h-0">
                        <div className="relative w-full" style={{ height: '320px' }}>
                            ...
                            {milestones?.map((milestone, index) => {
                                ...
                                // Position each milestone evenly across the width
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {isAbove && (
                                            <div
                                                className="mb-3 rounded-md px-4 py-3 border-l-[3px] text-left"
                                                style={{
                                            ...
                                            >
                                                <p
                                                    ...
                                                    style={{ color: 'var(--primary-color, #6366F1)', fontFamily: 'var(--heading-font-family, Inter)', letterSpacing: '0.07em' }}
                                                >
                                                    {milestone.phase}
                                                </p>
                                                <h3
                                        ...
                                        {!isAbove && (
                                            <div
                                                className="mt-3 rounded-md px-4 py-3 border-l-[3px] text-left"
                                                style={{
                                                    width: `${Math.max(140, Math.floor(820 / count) - 16)}px`,
                                                    backgroundColor: 'var(--card-color, #F3F4F6)',
                                                    borderLeftColor: 'var(--primary-color, #6366F1)',
