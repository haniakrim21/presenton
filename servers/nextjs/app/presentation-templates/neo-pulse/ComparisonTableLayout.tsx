        ...
        <>
            ...
            >
                ...
                <div className="flex flex-col h-full px-14 pt-12 pb-10">
                    ...
                    {/* Table */}
                    <div className="flex-1 flex flex-col min-h-0 overflow-hidden rounded-md" style={{ border: '1px solid var(--stroke, #E5E7EB)' }}>
                        {/* Header row */}
                        <div
                                    ...
                                    >
                                        ...
                                        {columns?.map((col, colIndex) => (
                                            <div
                                                ...
                                                style={{
                                                    borderLeft: col.highlighted ? '3px solid var(--primary-color, #6366F1)' : 'none',
                                                    borderRight: colIndex < (columns?.length ?? 0) - 1 ? '1px solid var(--stroke, #E5E7EB)' : 'none',
