        ...
        <>
            ...
            >
                ...
                <div className="flex flex-col h-full px-14 pt-12 pb-10">
                    ...
                    {/* Flat card containing the table — no border on card itself */}
                    <div
                        className="flex-1 flex flex-col min-h-0 overflow-hidden rounded-xl max-w-[960px] mx-auto w-full"
                        style={{ backgroundColor: 'var(--card-color, #F3F4F6)' }}
                    >
                        {/* Header row — pill labels for highlighted column */}
                        <div className="flex flex-shrink-0 px-2 pt-3 pb-2">
                            ...
                            {columns?.map((col, colIndex) => (
                                ...
                                >
                                    {col.highlighted ? (
                                        ...
                                        <span
                                            className="text-[13px] font-medium"
                                            style={{ color: 'var(--background-text, #101828)', opacity: 0.65, fontFamily: 'var(--heading-font-family, Inter)' }}
                                        >
                                            {col.name}
                                        </span>
                                    )}
                        ...
                        {/* Body rows — alternating background, no row borders */}
                            ...
                            {rows?.map((row, rowIndex) => {
                                ...
                                return (
                                    <div
                                        ...
                                        style={{
                                            backgroundColor: isEven ? 'var(--background-color, #ffffff)' : 'transparent',
                                        }}
                                    >
                                        {/* Feature name cell */}
                                        <div
