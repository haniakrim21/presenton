        ...
        <>
            ...
            >
                ...
                <div className="flex flex-col h-full px-14 pt-12 pb-10">
                    ...
                    {/* Team grid — 3 columns of flat rounded-xl cards */}
                    <div className="flex-1 grid grid-cols-3 gap-5 min-h-0 overflow-hidden max-w-[960px] mx-auto w-full">
                        {members?.map((member, index) => (
                            <div
                                key={index}
                                className="rounded-xl px-5 py-5 flex flex-col items-center text-center overflow-hidden"
                                style={{
                                    backgroundColor: 'var(--card-color, #F3F4F6)',
                                }}
                            >
                                {/* Avatar — no border, no outline */}
                                <div
                                ...
                                {member.role && (
                                    <span
                                        className="inline-flex items-center px-3 py-1 rounded-full text-[10px] font-semibold mb-2"
                                        style={{ backgroundColor: 'var(--primary-color, #6366F1)', color: 'var(--primary-text, #FFFFFF)' }}
                                    >
                                        {member.role}
                                    </span>
