            ...
            >
                ...
                <div className="flex flex-col h-full px-16 pt-14 pb-12">
                    ...
                    <div className="mb-5 flex-shrink-0">
                        ...
                        {subtitle && (
                            <p
                                className="text-[15px] leading-[1.85] max-w-[600px]"
                    ...
                    {/* Team grid — sharp editorial cards, no backgrounds, thin bottom border only */}
                    <div className="flex-1 grid grid-cols-3 min-h-0 overflow-hidden">
                        {members?.map((member, index) => {
                            ...
                            return (
                                <div
                                    key={index}
                                    className="flex flex-col items-start overflow-hidden px-5 py-4"
                                    style={{
                                        borderRight: isRightBorder ? '1px solid var(--stroke, #E5E7EB)' : 'none',
                                        borderBottom: '1px solid var(--stroke, #E5E7EB)',
                                    }}
                                >
                                    {/* Avatar — square, no rounded corners */}
                                    <div
                                        className="w-[52px] h-[52px] overflow-hidden flex-shrink-0 mb-3"
                                    ...
                                    {member.name && (
                                        <h3
                                            className="text-[15px] font-black leading-tight tracking-tight mb-1"
                                            style={{ color: 'var(--background-text, #101828)', fontFamily: 'var(--heading-font-family, Inter)' }}
                                        >
                                            {member.name}
                                        </h3>
                                    ...
                                    {member.description && (
                                        <p
                                            className="text-[12px] leading-[1.85] flex-1"
